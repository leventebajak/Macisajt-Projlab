...
public class GameOverWindow extends JPanel {
    ...
    private void initComponents(int n, String s1, String s2) {
        ...
        lResult1.setFont(new Font("Segoe UI", Font.BOLD, 40)); // NOI18N
        lResult1.setForeground(View.SECONDARY_COLOR);
        lResult1.setHorizontalAlignment(SwingConstants.CENTER);
        lResult1.setText(s1);

        lResult2.setFont(new Font("Segoe UI", Font.BOLD, 40)); // NOI18N
        ...
        bBackToMain.addActionListener(this::bNewGameActionPerformed);
